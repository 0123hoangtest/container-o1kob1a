...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o1kob1a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o1kob1a.containers.anotherwebservice.com/
...
```
git clone git@github.com:0123hoangtest/container-o1kob1a.git
cd container-o1kob1a
```
...
```
docker attach container-o1kob1a
```
